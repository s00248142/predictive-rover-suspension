...
/*******************************************************************************
* File Name: main.c
* Description: Embedded program for the ST B-G431B-ESC1
*   This primary purpose of this file is to call app_loop() from
* 	app.c repeatedly, passing in the 'target_speed' variable.
* 	The 'target_speed' variable is controlled external to the device using CAN.
* 	The CAN initialisation, callback function (HAL_FDCAN_RxFifo0Callback()), and
* 	send_feedback_frame() functions are the additionally created user code
* 	within this file.
* 	All other code in this file are auto-generated from Cube MX and ST Motor
* 	Control Workbench.
...
#include "app.h" // Rover project code.
#include "bus_voltage_sensor.h" //  Feedback battery level in rover CAN frame
...
/* Private define ------------------------------------------------------------*/
/* USER CODE BEGIN PD */
#define ESC_CMD_ID  0x006
#define ESC_FB_ID   0x306
#define CAN_MAX_RPM 600
/* USER CODE END PD */
...
extern SixStepVars_t SixStepVars[]; // For CAN
//extern BusVoltageSensor_Handle_t BusVoltageSensor_M1; // For CAN message
//uint16_t bus_v = VBS_GetAvBusVoltage_d(&BusVoltageSensor_M1);
...
void send_feedback_frame(void); // MIT-Style CAN
